---
created: 2026-01-02 13:07:31.054969
id: 01KDZ9P4ZE6MMDXJ0QZHK1TTGY
...
# Create a Custom Code Review Skill with Claude's Skill Creator
...
## Validation
- [ ] Claude successfully performs the deep research and generates a 'research.md' file (see 19:26).
- [ ] Claude triggers the 'skill creator' skill (see 19:56).
- [ ] A new skill folder (e.g., 'NestJS code review skill') is created in your 'skills' directory (see 20:09).
- [ ] The `skill.md` file within the new skill folder outlines the review phases (architecture, file structure, detailed component, documentation) and expert perspectives (see 20:42).
- [ ] The skill definition includes criteria for when to use the skill (e.g., reviewing pull requests, code changes) (see 20:28).
